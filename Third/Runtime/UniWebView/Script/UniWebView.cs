...
public class UniWebView: MonoBehaviour {
    ...
    public void UpdateFrame() {
        ...
        Debug.Log("UpdateFrame:" + rect.ToString() + "Scale:"+ ScreenScale);
        UniWebViewInterface.SetFrame(listener.Name, (int)(rect.x/ScreenScale), (int)(rect.y/ScreenScale), (int)(rect.width/ScreenScale), (int)(rect.height/ScreenScale));
    }
