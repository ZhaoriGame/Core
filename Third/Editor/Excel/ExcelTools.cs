...
//
//
//     private static string mOutPutPath = "/Assets/Resources/hot_res/configs/";
//
//     /// <summary>
//     /// 显示当前窗口	
//     /// </summary>
...
//
//
//     [MenuItem("Plugins/AllConv")]
//     static void AllExcelConvert()
//     {
//         //Init();
//         //加载Excel文件
//         //LoadExcel();
...
//         DirectoryInfo root = new DirectoryInfo(pathRoot + "/Excel");
//
//         var infos = root.GetDirectories();
//
//         foreach (var VARIABLE in infos)
//         {
//             string[] path = Directory.GetDirectories(VARIABLE.FullName);
//             foreach (var p in path)
//             {
//                 excelPaths.Add(p);
//             }
//
//             excelPaths.Add(VARIABLE.FullName);
//         }
//
//         excelList = new List<string>();
//         foreach (var excelPath in excelPaths)
//         {
//             // string[] paths = Path.get(excelPath);
...
//
//             //判断输出类型
//             excelPath = pathRoot + "/Resources/hot_res/configs/" + Path.GetFileName(assetsPath);
//             //"D:/NewSVN/project/Game/GameRPG/GameRPG/Assets/Excel/Assets/Resources/hot_res/configs/D:\NewSVN\project\Game\GameRPG\GameRPG\Assets\Excel\Map\Map1\Map1001Change.xlsx"
//             string output = "";
//             if (indexOfFormat == 0)
//             {
...
//         }
//
//         Debug.LogError("共有" + count + "个表格转换完成");
//         //刷新本地资源
...
//             pathSplit = GameUtils.JsonConvert2List<string>(assetsPath, "/");
//
//             //判断输出类型
//             excelPath = pathRoot + mOutPutPath + pathSplit[pathSplit.Count - 1];
//             string output = "";
//             if (indexOfFormat == 0)
//             {
//                 output = excelPath.Replace(".xlsx", ".json");
